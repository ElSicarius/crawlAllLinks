...
class BurpExtender(IBurpExtender,IContextMenuFactory):
    ...
    def	registerExtenderCallbacks(self, callbacks):
        ...
        self.callbacks.setExtensionName("SicExt")
        self.callbacks.registerContextMenuFactory(self)
        return

    def createMenuItems(self,invocation):
        menu_list = []
        menu_list.append(JMenuItem("This is an example",None,actionPerformed= lambda x, inv=invocation:self.startThreaded(self.start_scan,inv)))
        return menu_list
